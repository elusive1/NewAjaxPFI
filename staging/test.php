...
var contentUrl = "staging.psgdemo.com/NewAjaxPFI/staging/loading.php?a=<?php echo $_SERVER['HTTP_X_PFI_ALIAS']?>&status=<?php echo $_SERVER['HTTP_X_PFI_STATUS']?>&sessionToken=<?php echo $_SERVER['HTTP_X_PFI_SESSIONTOKEN']?>&t=<?php echo $_SERVER['HTTP_X_PFI_TRANSACTIONID']?>";
var contentId = "sub2";
